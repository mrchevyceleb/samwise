...
async fn worker_loop(
    ...
    // Sweep hook remains on startup and every 6h when idle, but destructive
    // worktree cleanup is disabled after the 2026-09-05 data-loss incident.
...
from Matt, stop without making changes and explain specifically what you need clarified."
    ...
    // Worktree persists on disk. Destructive sweeping is disabled after the
    // 2026-09-05 incident, so merged/closed/orphan trees are not auto-removed.
